...
hdfs dfs -cat mpd_artist_output/part-* > artist_output.txt
# hdfs dfs -cat mpd_album_output/part-* > album_output.txt
hdfs dfs -cat mpd_track_output/part-* > track_output.txt
